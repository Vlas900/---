...
while True:
    ...
    if game_over:
        ...
        texst1 = font.render(game_over,True,white)
        texst_rect = texst1.get_rect()
        texst_x = screen.get_width() / 2 - texst_rect.width / 2
        texst_y = screen.get_height() / 2 - texst_rect.height / 2
        screen.blit(texst1, [texst_x, texst_y])
